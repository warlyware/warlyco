...
export default function Home() {
  return (
    <div className="flex justify-center items-end bg-cyan-200 min-h-screen relative text-purple-700">
      <Head>
        <title>warlyco</title>
      ...
      <Image
        ...
        height={800}
      />
      <div className="absolute h-screen w-screen top-0 bottom-0 right-0 left-0">
        <div className="title flex w-full justify-center h-1/3">
        ...
        <div className="title flex w-full justify-around h-1/3 px-32">
        ...
        <div className="title flex w-full justify-between h-1/3">
          <div className="relative w-1/3 flex justify-center items-center">
      ...
      <a
        ...
        target="_blank"
        className="absolute top-0 w-full text-center border border-purple-700 hover:bg-orange-500"
        rel="noreferrer"
      >
      ...
      <a
        ...
        target="_blank"
        className="absolute flex flex-col justify-center left-0 h-screen border border-purple-700 hover:bg-orange-500"
        rel="noreferrer"
      >
      ...
      <a
        ...
        target="_blank"
        className="absolute flex flex-col justify-center right-0 h-screen border border-purple-700 hover:bg-orange-500"
        rel="noreferrer"
      >
